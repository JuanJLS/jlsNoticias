...
//Mostrar Modales view Register&Login:
...
//Mostrar Modales view Home:
    let changePassword = document.getElementById('passwordchange');
    if(changePassword) {
        $('#passwordModal').modal('show');
    }
    let changeUser =document.getElementById('userchange') ;
    if(changeUser) {
        $('#userModal').modal('show');
    }
    let restoreEmail = document.getElementById('restore');
    if(restoreEmail) {
